...
DO ips=1,nvgt
   ...
   DO ii=1,ni-1
      ...
      READ(20,*)gor(ii),got(ii),gop(ii) !220108 Donglin Choi
      READ(20,*)gsr(ii),gst(ii),gsp(ii) !220108 Donglin Choi
      IF(ii.GT.1)THEN
     ...
     !gop(ii)=gop(ii)+gsp(ii)
      IF(ii.EQ.1)THEN
         ...
         ENDIF
      ENDIF
      DO k=0,nnp(ii)+1 !220108 Donglin Choi
         DO j=0,nnt(ii)+1 !220108 Donglin Choi
            DO i=0,nnr(ii)+1 !220108 Donglin Choi
               IF(vgid.EQ.0)THEN
                  READ(20,*)veln(i,j,k,ii) !220108 Donglin Choi
               ELSE
                  READ(20,*)
               ENDIF
            ENDDO
   ...
   DO ips=1,nvgt
      DO ii=1,ni-1
        ...
        !idm3=idm3-2
         ...
         ENDIF
         READ(20,*)rd1,rd2,rd3
         READ(20,*)rd1,rd2,rd3 !220108 Donglin Choi
        !rd2=rd2*180.0/pi
        !rd3=rd3*180.0/pi
         ...
         DO k=0,nnp(ii)+1 !220108 Donglin Choi
            DO j=0,nnt(ii)+1 !220108 Donglin Choi
               DO i=0,nnr(ii)+1 !220108 Donglin Choi
                  READ(20,*)rd1
                  IF(nvgt.EQ.1.OR.nvgt.EQ.2.AND.ips.EQ.2)THEN
                     rd1=veln(i,j,k,ii)-rd1 !220108 Donglin Choi
                     veln(i,j,k,ii)=rd1 !220108 Donglin Choi
                  ENDIF
               ENDDO
            ENDDO
         ENDDO
